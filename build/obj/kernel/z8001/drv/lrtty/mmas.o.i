...
/
mmstuff_:
ld	r0, SS|2+2*[1](spo)	/ Load offset,
ld	r1, SS|2+2*[2](spo)	/ value,
ld	r2, SS|2+2*[3](spo)	/ count,
ldl	rr4, SS|2+2*[4](spo)	/ and screen memory base.
pushl	(sp), rr6
...
/
mmcopy_:
ld	r0, SS|2+2*[1](spo)		/ Load source offset,
ld	r1, SS|2+2*[2](spo)		/ destination offset,
ld	r2, SS|2+2*[3](spo)		/ count,
ld	r3, SS|2+2*[4](spo)		/ direction,
ldl	rr4, SS|2+2*[5](spo)		/ and screen memory base.
pushl	(sp), rr6
...
/
mmcrt_:
ld	r0, SS|2+2*[1](spo)	/ Load register number
ld	r1, SS|2+2*[2](spo)	/ and value.
