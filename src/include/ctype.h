...
#define	isalpha(c)	((_ctype+129)[(c)]&_A)
#define	isupper(c)	((_ctype+129)[(c)]&_U)
#define	islower(c)	((_ctype+129)[(c)]&_L)
#define	isdigit(c)	((_ctype+129)[(c)]&_D)
#define	isalnum(c)	((_ctype+129)[(c)]&(_A|_D))
#define	isspace(c)	((_ctype+129)[(c)]&_S)
#define	ispunct(c)	((_ctype+129)[(c)]&_P)
#define	isprint(c)	((_ctype+129)[(c)]&(_P|_X|_A|_D))
#define	iscntrl(c)	((_ctype+129)[(c)]&_C)
